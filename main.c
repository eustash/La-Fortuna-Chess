unsigned char kg[BOARD_SQUARE_SIZE][4] = {{255,255,255,255},{255,255,255,255},{255,255,255,63},{255,1,255,63},{255,252,252,63},{127,255,251,63},{127,135,247,63},{191,3,14,0},{191,1,28,13},{255,3,152,13},{127,3,152,13},{255,30,152,5},{31,252,153,4},{237,199,223,6},{48,63,192,6},{253,63,223,6},{237,241,159,6},{255,252,152,4},{127,15,152,5},{127,3,152,13},{191,1,152,13},{191,1,156,13},{191,1,14,0},{191,129,247,63},{127,231,249,63},{127,254,252,63},{255,56,255,63},{255,227,255,63},{255,255,255,255},{255,255,255,255}};
unsigned char hs[BOARD_SQUARE_SIZE][4] = {{255,255,255,255},{255,255,255,255},{255,255,249,63},{255,127,246,63},{255,31,230,63},{255,7,224,63},{255,0,224,63},{127,0,224,63},{63,7,248,63},{135,7,252,35},{143,1,252,32},{31,0,60,32},{1,0,30,32},{3,0,14,32},{15,0,2,32},{127,240,0,32},{255,48,0,32},{255,0,0,32},{191,1,0,32},{127,7,0,32},{255,14,0,32},{255,61,0,32},{255,255,0,32},{255,239,31,32},{255,63,255,63},{255,255,195,63},{255,255,255,32},{255,255,255,255},{255,255,255,255},{255,255,255,255}};

position current_cursor_position = {0, 0};

piece pieces[32] = {
	{{0,0},'r',0},{{1,0},'h',0},{{2,0},'b',0},{{3,0},'q',0},{{4,0},'k',0},
	{{5,0},'b',0},{{6,0},'h',0},{{7,0},'r',0},{{0,1},'p',0},{{1,1},'p',0},
	{{2,1},'p',0},{{3,1},'p',0},{{4,1},'p',0},{{5,1},'p',0},{{6,1},'p',0},
	{{7,1},'p',0},

	{{0,7},'r',1},{{1,7},'h',1},{{2,7},'b',1},{{3,7},'q',1},{{4,7},'k',1},
	{{5,7},'b',1},{{6,7},'h',1},{{7,7},'r',1},{{0,6},'p',1},{{1,6},'p',1},
	{{2,6},'p',1},{{3,6},'p',1},{{4,6},'p',1},{{5,6},'p',1},{{6,6},'p',1},
	{{7,6},'p',1}
};
...
void draw_square(int8_t x, int8_t y){
	...
	for(i = 0; i < 16; i++){
		...
		display_string_xy(debug, 240, i*10 + 40);
	}
}
	...
	if(selected_piece->pos.x == -1 && selected_piece->pos.y == -1){
		switch(selected_piece->type){
			...
			case 'h':
				...
				break;
			case 'b':
				if(abs(previous_selected_position.x-current_cursor_position.x) == abs(previous_selected_position.y-current_cursor_position.y)){
					return true;
				}
				break;
			case 'k':
			...
			case 'q':
				if(!(previous_selected_position.x != current_cursor_position.x 
					&& previous_selected_position.y != current_cursor_position.y)){
					return true;
				} else if(abs(previous_selected_position.x-current_cursor_position.x) == abs(previous_selected_position.y-current_cursor_position.y)){
					return true;
				}
				break;
		}
